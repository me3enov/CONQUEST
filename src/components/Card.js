...
export default class Card {
  ...
  getTemplateCard() {
    const cardElement = document
      ...
      .content.querySelector(this.CARD_SELECTOR)
      .cloneNode(true);
    return cardElement;
  }
  ...
  getTemplatePromoTexts() {
    const promoElement = document
      ...
      .content.querySelector(this.PROMO_BOX_SELECTOR)
      .cloneNode(true);
    return promoElement;
  }
  ...
  addCardAllHovered() {
    this.element.classList.contains(this.CARD_SELECTED_CLASS)
      ? this.addCardSecectedHovered()
      : this.addCardHovered();
  }

  removeCardAllHovered() {
    this.element.classList.contains(this.CARD_SELECTED_CLASS)
      ? this.removeCardSecectedHovered()
      : this.removeCardHovered();
  }
  ...
  generateCard() {
    ...
    this.promoElements = Object.values(this.promoItems).forEach((elem) =>
      this.generatePromoText(elem)
    );
